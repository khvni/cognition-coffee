...
**Pop-up events** generate energy but require central coordination every time. Growth is linear: each event is a unit of work.
...
The top-tier ambassadors from [the Roasters' Guild](/blog/brewing-community-90-days/#days-6090-the-roasters-guild--the-ambassador-program). Each champion owns a metro area or university cluster. They coordinate local hosts, run regional events, and carry feedback from their community to the product team.
