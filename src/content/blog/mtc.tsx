...
export const frontmatter = {
  ...
  description:
    "I started MTC at UC Berkeley in spring 2023 with 8 people. Three years later: 30+ chapters, city hubs, and a $500K grant offer on the table. What worked, what I'd do differently.",
  date: "2026-06-26",
  category: "Community",
  order: 0,
  draft: false,
...
const Content: FC = () => (
  <>
    ...
    <p>
      By the end of the first year, students at other universities started asking how to start their own chapters. That's when the work shifted to building a system so other people could build things.
    </p>
    ...
    <p>
      Every chapter lead gets invited to a centralized Slack workspace on the nonprofit plan. Chapter presidents can DM me directly. Regional leads have their own channels. There's a #chapter-presidents channel for cross-chapter questions, a #events channel for sharing what's working, and per-chapter channels for local coordination.
    </p>
    <p>
      The Slack is the closest thing we have to organizational memory. When a new chapter president takes over, they inherit the channel history and can scroll back to see how previous leaders handled the same problems.
    </p>

    <h3>Canva templates and branding kit</h3>
    <p>
      Every chapter needs to promote its events. Most chapter leads are not designers. So we built Canva templates for Instagram posts, event flyers, and story graphics. A chapter lead can duplicate the template, swap the text, and have a postable graphic in five minutes.
    </p>
    <p>
      We paired that with an internal branding kit: logo files, color palette, typography, usage guidelines. Any chapter anywhere can produce materials that look like MTC. Chapters self-generate their logo from the template, I approve it, and they're live.
    </p>
    ...
    <p>
      We have a $500K grant offer that's been sitting unclaimed for nine months because the precondition is hiring a full-time lead. The one place we shipped in 2026 is the one place we paid someone.
    </p>
    <ProsePullQuote>
