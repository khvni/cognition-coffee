...
export const frontmatter = {
  ...
  description:
    "I have 1.7 million documented views on a Quora account I will not link you to. Here is what the number taught me.",
  date: "2026-06-12",
...
const Content: FC = () => (
  <>
    <p>
      I have about 1.7 million documented views on a Quora account I will not be linking you to. The real number is somewhere around seven million, but I purged most of the evidence. What's left is embarrassing enough.
    </p>
    <p>
    ...
    <p>
      ...
      <a href="https://www.quora.com/profile/Allen-Kinney">The account</a> is still up, if you want to see what fourteen-year-old me thought was profound.
    </p>
    <p>
    ...
    <p>
      My friend — who I'd pulled into my Quora escapade — cared about views. He eventually{" "}
      <a href="https://press.alif.build/p/what-writing-on-quora-taught-me-about">wrote an essay</a>{" "}
      about this, and I'm the weird friend in it. He found me crossing seven million total views and wanted to talk about the number. I was focused on my latest answer: who was reading it, what the comments said, whether it had started a conversation. The raw metric didn't interest me. The quorum did. Could I get strangers to actually start talking because of something I made?
    </p>
    ...
    <p>
      You can still find Allen Kinney at his old profile. I don't touch it anymore. Some of what's there is as embarrassing as I warned you. But it also has 1.7 million views from strangers who owed him nothing — and that number doesn't lie.
    </p>
    <p>
      See{" "}
