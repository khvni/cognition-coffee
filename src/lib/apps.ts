...
export const APPS: AppDef[] = [
  { id: "home", title: "Welcome", path: "/", blurb: "Curriculum, meetups, and ambassadors \u2014 the plan for Devin's community.", icon: "home", size: { w: 720, h: 460 }, center: true },
  { id: "menu", title: "Menu", path: "/menu", blurb: "Three programs. Curriculum, meetups, and ambassadors.", icon: "menu", size: { w: 680, h: 560 }, desktop: true },
  { id: "blog", title: "Blog", path: "/blog", blurb: "Playbooks for building Devin's community.", icon: "blog", size: { w: 760, h: 600 }, desktop: true },
  { id: "community", title: "Community", path: "/community", blurb: "30+ cities. Local chapters. Weekly office hours.", icon: "community", size: { w: 680, h: 560 }, desktop: true },
  { id: "about", title: "About", path: "/about", blurb: "Community builder. Scaled MTC to 30+ chapters. Top-200 Devin user.", icon: "about", size: { w: 640, h: 560 }, desktop: true },
