...
export const TaskBar: React.FC = () => {
  ...
  return (
    <div role="toolbar" aria-label="Taskbar" className="absolute inset-x-0 bottom-0 z-[9999] flex h-10 items-center gap-2 border-t border-line bg-panel/90 px-3 backdrop-blur">
